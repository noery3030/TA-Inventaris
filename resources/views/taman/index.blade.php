  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">06-Taman</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href={{ 'home' }}>Home</a></li>
              <li class="breadcrumb-item active">Taman</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Barang Inventaris Area Taman</h3> 
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            @foreach ($ar_barang as $b)
                <tr>
                    ...
                    @else
                      ...
                      @endif
                    <td>{{ $b->keterangan }}</td>
                    <td class="text-center"><a class="text-secondary fw-bolder" href="{{ route('taman.show',$b->id) }}">Detail</a></td>
                </tr>
            @endforeach
        </tbody>
      </table>
