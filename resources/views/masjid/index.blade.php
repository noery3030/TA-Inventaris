    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Barang Inventaris Area Masjid</h3> 
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            @foreach ($ar_barang as $b)
                <tr>
                    ...
                    @else
                      ...
                      @endif
                    <td>{{ $b->keterangan }}</td>
                    <td class="text-center"><a class="text-secondary fw-bolder" href="{{ route('masjid.show',$b->id) }}">Detail</a></td>
                </tr>
            @endforeach
        </tbody>
      </table>
